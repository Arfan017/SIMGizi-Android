...
public class TrackingService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // Membuat notifikasi wajib untuk Foreground Service
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.ic_data_distribusi) // Ganti dengan ikon notifikasi Anda
                .build();

        // Mulai layanan di foreground
        startForeground(1, notification);

        // Mulai meminta update lokasi
        startLocationUpdates();

        // START_STICKY berarti layanan akan coba dihidupkan kembali jika dimatikan sistem
        return START_STICKY;
    }

    private void startLocationUpdates() {
        LocationRequest locationRequest = LocationRequest.create();
        locationRequest.setInterval(15000); // Interval 15 detik
        locationRequest.setFastestInterval(10000); // Interval tercepat 10 detik
    ...
    public void onDestroy() {
        super.onDestroy();
        // Hentikan update lokasi saat layanan dihentikan
